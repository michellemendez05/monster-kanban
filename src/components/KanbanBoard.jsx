  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 w-full max-w-6xl">
      <Column
        ...
        onRemove={removeTask}
        name="backlog"
        monster={{ color: "bg-pink-500", height: "h-14" }}
      />
      <Column
        title="Doing"
        color="bg-orange-200"
        ...
        onRemove={removeTask}
        name="doing"
        monster={{ color: "bg-orange-500", height: "h-15" }}
      />
      <Column
        title="Review"
        color="bg-green-200"
        ...
        onRemove={removeTask}
        name="review"
        monster={{ color: "bg-green-500", height: "h-20" }}
      />
      <Column
        title="Done"
        color="bg-blue-200"
        ...
        onRemove={removeTask}
        name="done"
        monster={{ color: "bg-blue-500", height: "h-25" }}
      />
    </div>
  );
}
